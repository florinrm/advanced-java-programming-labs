...
public class BankApplication {
	...
	private static void printBankStatistics(Bank bank) {
		...
		System.out.println(bankReportStreams.getAccountsSortedBySum(bank));
		System.out.println(bankReportStreams.getBankCreditSum(bank));
		System.out.println(bankReportStreams.getCustomerAccounts(bank));
